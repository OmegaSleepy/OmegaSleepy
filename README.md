...
- **Backend:** Deep interest in Java & Kotlin (JVM ecosystem).
- **DBs:** Proficient in SQL (MySQL, SQLite), focusing on useful integration with jdbc.
- **Networking:** Currently exploring HTTPS implementations and RESTful APIs using **Java Spark**.
- **Other:** Actively participating in Programming Olympiads.
